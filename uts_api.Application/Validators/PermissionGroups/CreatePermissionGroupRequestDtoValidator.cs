...
public sealed class CreatePermissionGroupRequestDtoValidator : AbstractValidator<CreatePermissionGroupRequestDto>
{
    public CreatePermissionGroupRequestDtoValidator()
    {
        RuleFor(x => x.Name)
