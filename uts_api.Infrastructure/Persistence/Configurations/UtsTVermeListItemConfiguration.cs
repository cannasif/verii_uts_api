...
public sealed class UtsTVermeListItemConfiguration : IEntityTypeConfiguration<UtsTVermeListItem>
{
    public void Configure(EntityTypeBuilder<UtsTVermeListItem> builder)
    {
        builder.ToView(UtsQueries.UtsTVermeListViewName);
        builder.HasNoKey();
