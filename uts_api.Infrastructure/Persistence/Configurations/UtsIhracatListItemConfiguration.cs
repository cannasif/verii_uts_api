...
public sealed class UtsIhracatListItemConfiguration : IEntityTypeConfiguration<UtsIhracatListItem>
{
    public void Configure(EntityTypeBuilder<UtsIhracatListItem> builder)
    {
        builder.ToView(UtsQueries.UtsIhracatListViewName);
        builder.HasNoKey();
