...
public sealed class UtsImhaListItemConfiguration : IEntityTypeConfiguration<UtsImhaListItem>
{
    public void Configure(EntityTypeBuilder<UtsImhaListItem> builder)
    {
        builder.ToView(UtsQueries.UtsImhaListViewName);
        builder.HasNoKey();
        ...
        builder.Property(x => x.UtsDurum).HasColumnName("UTS_DURUM").HasMaxLength(1);
        ...
        builder.Property(x => x.Grk).HasColumnName("GRK").HasMaxLength(100);
    }
}
